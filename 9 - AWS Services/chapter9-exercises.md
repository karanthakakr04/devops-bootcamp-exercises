...
- [ ] **Task 3: Set user details**
  - On the "Create user" page:
    - You will be presented with two options: "AWS IAM Identity Center" and "IAM User". Select "IAM User" to create a new IAM user.
...
- [ ] **Task 4: Set permissions for the IAM user**
  ...
  - AWS recommends adding the user to a group and then attaching policies to the group. Select **Add user to group**.
  - Click on **Create group**.
    - **Group name:** Enter "devops".
    - In the **Filter policies** box, type relevant policies based on the permissions the user needs. Avoid using overly permissive policies such as `AdministratorAccess`.
...
- [ ] **Task 7: Retrieve the IAM user credentials**
  ...
  - Click on the **Return to users list** button.
