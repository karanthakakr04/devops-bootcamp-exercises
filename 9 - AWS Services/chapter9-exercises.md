...
- [ ] **Task 2: Navigate to IAM Service**
  - On the AWS Management Console home page, you can either:
    - Find "IAM" under the "Security, Identity, & Compliance" section and click on it, or
    - Use the search bar at the top to search for "IAM" and click on the "IAM" result.

- [ ] **Task 3: Create IAM User**
  ...
  - Under **Console password**, select **Autogenerated password**.
  - Ensure the **Users must create a new password at next sign-in** checkbox is checked.
  - Click **Next**.

- [ ] **Task 4: Set Permissions for the User**
  - On the **Set permissions** page, select **Add user to group**.
  - Click on **Create group**.
    - In the **Group name** field, enter **devops**.
    - In the **Filter policies** box, type **AdministratorAccess**.
    - Check the box next to **AdministratorAccess**.
    - Click the **Create group** button.
  - Ensure the new user is added to the **devops** group.
  - Click **Next**.

- [ ] **Task 5: Add Tags (Optional)**
  - (Optional) Add any tags if required by clicking **Add tag**.
    - Enter the key-value pairs for the tags.
  - Click **Next: Review**.

- [ ] **Task 6: Review and Create User**
  - Review the user details and permissions to ensure everything is correct.
  - Click the **Create user** button.

- [ ] **Task 7: Retrieve and Save Credentials**
  - On the success page, click the **Download .csv** button to save the user’s credentials.
  - Save the file securely as it contains the sign-in URL, user name, and password.
